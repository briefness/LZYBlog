...
*   **意图共享**：将你的业务逻辑封装为“意图”注册给系统。
*   **场景举例**：
    *   告诉系统“用户正在听歌” -> 小艺建议可能会在特定时间推荐你的 App。
    *   注册“搜索食谱”意图 -> 用户在系统全局搜索栏输入菜名，直接展示你 App 内的食谱卡片。

## 五、总结

针对不同的智慧场景，我们要选择合适的技术方案：
...
结合这些智慧能力，你的应用将不再是一个孤岛，而是鸿蒙智慧生态有机的一部分。

下篇文章，我们将回归架构设计，讨论如何管理日益复杂的代码——**[组件化与工程架构](./Components.md)**。
