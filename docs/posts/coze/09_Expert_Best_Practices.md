...
```mermaid
flowchart LR
    Build["🏗️ 构建 Agent"] --> Test["🧪 多轮对话测试"]
    Test --> Debug["🔍 调试分析<br/>Prompt / 工作流"]
    Debug --> Opt["⚙️ 优化策略<br/>模型选择 / 参数"]
    Opt --> Test
    Test -->|"达标"| Ship["🚀 发布上线"]
```
...
Coze 提供了多种模型（DeepSeek, Doubao, GPT-4o, MiniMax, Moonshot 等）。

*   **Doubao-Pro / Moonshot (Kimi)**：中文理解极佳，逻辑能力强，是 Coze 国内版的主力模型。
*   **DeepSeek-R1 / V3**：推理能力突出，性价比高，适合复杂逻辑任务。
*   **GPT-4o (Intl)**：在 Coze 海外版中可用，多模态能力强。
