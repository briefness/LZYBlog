# Coze 零基础精通系列 08：多智能体 (Multi-Agent)与触发器 —— 组建你的 AI 团队
...
## 4. 多智能体模式简介
在 Coze 的 **“多 Agent 模式”**（通常在创建 Bot 时选择模式）下，开发者可以：
1.  创建一个 **Manager** 节点。
2.  把其他的 Bot（比如“画图大师”、“文案高手”）添加为 Manager 的子节点。
3.  配置 Manager：“如果用户要画图，就找画图大师；如果要写文章，就找文案高手。”

类似公司架构，各司其职。这是 Coze 2.0 最核心的功能，解决了单一 Prompt 难以处理复杂逻辑的问题。当任务过于庞大时，**拆解**永远是最好的解法。
