...
* **“手不够长”**：想让它帮你查各种实时新闻，或者直接发邮件，它做不到。
* **“不稳定”**：精心调好的提示词，下次用还得复制粘贴。
...
> 💡 **进阶说明**：
> Coze 官方现已推出 **“扣子编程 (Coze Programming)”** 体系，包含 **低代码开发**（即本教程重点讲解的拖拽式 Workflow/Bot 搭建）和 **AI 编程**（纯代码开发）。本教程聚焦于低代码模式，适合 99% 的场景；若有极客需求，Coze 也提供了完整的 IDE 环境供开发者写代码。
