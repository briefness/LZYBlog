...
RAG 的核心在于相似度匹配。在数学上，就是计算两个向量在多维空间中的距离。
...
如果有 100 万个文档，每次查询都遍历计算 100 万次余弦相似度（KNN, K-Nearest Neighbors），效率极低。
...
**通俗类比：高铁站 vs 公交站**
*   **Linear Search**: 类似于公交车。从第 1 站坐到第 100 站，一站站停。速度慢。
*   **HNSW**: 建立了**多级交通网络**。
